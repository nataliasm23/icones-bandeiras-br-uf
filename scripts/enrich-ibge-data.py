...
Updates: data/municipios.json with new fields:
  populacao_2022, area_km2, densidade_demo,
  regiao_imediata, regiao_intermediaria

Usage:
  python3 scripts/enrich-ibge-data.py
"""
...
def main():
    ...
    for mun in municipios:
        ...
        if pop is not None and area is not None and area > 0:
            mun["densidade_demo"] = round(pop / area, 2)
    ...
    if sp:
        ...
        print(f"    Population: {sp.get('populacao_2022', 'N/A'):,}")
