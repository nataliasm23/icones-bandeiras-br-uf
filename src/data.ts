...
interface MunicipioRow {
  ...
  prefeito_eleito_2024: string | null;
  prefeito_nome_urna: string | null;
  prefeito_partido: string | null;
  prefeito_coligacao: string | null;
  prefeito_genero: string | null;
  prefeito_escolaridade: string | null;
  prefeito_cor_raca: string | null;
  vice_prefeito_2024: string | null;
  vice_partido: string | null;
  vereadores_eleitos: number | null;
  vagas_vereadores: number | null;
  fundeb_2024: number | null;
  fpm_2024: number | null;
  ideb_anos_iniciais_2023: number | null;
  ideb_anos_finais_2023: number | null;
  matriculas_2024: number | null;
  escolas_2024: number | null;
  docentes_2024: number | null;
  has_flag: number;
  has_icons: number;
...
function rowToMunicipio(row: MunicipioRow): Municipio {
  ...
  if (row.codigo_tse) m.codigo_tse = row.codigo_tse;
  if (row.prefeito_eleito_2024) m.prefeito_eleito_2024 = row.prefeito_eleito_2024;
  if (row.prefeito_nome_urna) m.prefeito_nome_urna = row.prefeito_nome_urna;
  if (row.prefeito_partido) m.prefeito_partido = row.prefeito_partido;
  if (row.prefeito_coligacao) m.prefeito_coligacao = row.prefeito_coligacao;
  if (row.prefeito_genero) m.prefeito_genero = row.prefeito_genero;
  if (row.prefeito_escolaridade) m.prefeito_escolaridade = row.prefeito_escolaridade;
  if (row.prefeito_cor_raca) m.prefeito_cor_raca = row.prefeito_cor_raca;
  if (row.vice_prefeito_2024) m.vice_prefeito_2024 = row.vice_prefeito_2024;
  if (row.vice_partido) m.vice_partido = row.vice_partido;
  if (row.vereadores_eleitos != null) m.vereadores_eleitos = row.vereadores_eleitos;
  if (row.vagas_vereadores != null) m.vagas_vereadores = row.vagas_vereadores;
  if (row.fundeb_2024 != null) m.fundeb_2024 = row.fundeb_2024;
  if (row.fpm_2024 != null) m.fpm_2024 = row.fpm_2024;
  if (row.ideb_anos_iniciais_2023 != null) m.ideb_anos_iniciais_2023 = row.ideb_anos_iniciais_2023;
  if (row.ideb_anos_finais_2023 != null) m.ideb_anos_finais_2023 = row.ideb_anos_finais_2023;
  if (row.matriculas_2024 != null) m.matriculas_2024 = row.matriculas_2024;
  if (row.escolas_2024 != null) m.escolas_2024 = row.escolas_2024;
  if (row.docentes_2024 != null) m.docentes_2024 = row.docentes_2024;
