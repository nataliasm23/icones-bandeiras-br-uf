...
CREATE TABLE municipios (
    ...
    veiculos_ano TEXT,
    codigo_tse TEXT,
    prefeito_eleito_2024 TEXT,
    prefeito_nome_urna TEXT,
    prefeito_partido TEXT,
    prefeito_coligacao TEXT,
    prefeito_genero TEXT,
    prefeito_escolaridade TEXT,
    prefeito_cor_raca TEXT,
    vice_prefeito_2024 TEXT,
    vice_partido TEXT,
    vereadores_eleitos INTEGER,
    vagas_vereadores INTEGER,
    fundeb_2024 REAL,
    fpm_2024 REAL,
    ideb_anos_iniciais_2023 REAL,
    ideb_anos_finais_2023 REAL,
    matriculas_2024 INTEGER,
    escolas_2024 INTEGER,
    ...
    for mun in municipios_raw:
        ...
        cursor.execute(
            """INSERT INTO municipios (
                ...
                idhm, veiculos, veiculos_ano,
                codigo_tse, prefeito_eleito_2024, prefeito_nome_urna,
                prefeito_partido, prefeito_coligacao,
                prefeito_genero, prefeito_escolaridade, prefeito_cor_raca,
                vice_prefeito_2024, vice_partido, vereadores_eleitos,
                vagas_vereadores,
                fundeb_2024, fpm_2024,
                ideb_anos_iniciais_2023, ideb_anos_finais_2023,
                matriculas_2024, escolas_2024, docentes_2024,
            ...
            (
                ...
                mun.get("idhm"),
                mun.get("veiculos"),
                mun.get("veiculos_ano") or None,
                mun.get("codigo_tse") or None,
                mun.get("prefeito_eleito_2024") or None,
                mun.get("prefeito_nome_urna") or None,
                mun.get("prefeito_partido") or None,
                mun.get("prefeito_coligacao") or None,
                mun.get("prefeito_genero") or None,
                mun.get("prefeito_escolaridade") or None,
                mun.get("prefeito_cor_raca") or None,
                mun.get("vice_prefeito_2024") or None,
                mun.get("vice_partido") or None,
                mun.get("vereadores_eleitos"),
                mun.get("vagas_vereadores"),
                mun.get("fundeb_2024"),
                mun.get("fpm_2024"),
                mun.get("ideb_anos_iniciais_2023"),
                mun.get("ideb_anos_finais_2023"),
                mun.get("matriculas_2024"),
                mun.get("escolas_2024"),
                mun.get("docentes_2024"),
                has_flag,
                has_icons_int,
