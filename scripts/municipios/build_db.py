...
def run(*, dry_run=False):
    ...
    if dry_run:
        ...
        print(f"  Outputs:")
        print(f"    {DATA_DIR / 'municipios.json'}")
        print(f"    {DATA_DIR / 'municipios-by-uf.json'}")
        print(f"    {DATA_DIR / 'municipios.csv'}")
        print(f"    {DATA_DIR / 'stats.json'}")
        return
