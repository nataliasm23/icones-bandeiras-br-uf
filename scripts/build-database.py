...
def build_database():
    ...
    for mun in municipios_raw:
        ...
        entry = {
            ...
            "regiao_imediata": mun.get("regiao_imediata", ""),
            "regiao_intermediaria": mun.get("regiao_intermediaria", ""),
            "populacao_2022": mun.get("populacao_2022"),
            "area_km2": mun.get("area_km2"),
            "densidade_demo": mun.get("densidade_demo"),
